...
describe("List", () => {
  it("should have expteced DOM output", () => {
    ...
    expect(screen.getByRole("list")).toHaveStyleRule("margin-bottom", SPACINGS_AFTER.NORMAL);
  });

  it("ListItem should have expected output", () => {
    render(<ListItem dataTest="bur">kek</ListItem>);
    expect(screen.getByTestId("bur")).toBeInTheDocument();
